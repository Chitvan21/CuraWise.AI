      ...
      <div className="border-t border-teal-500/10 p-4 glass-strong shrink-0">
        <div className="max-w-3xl mx-auto flex gap-2 items-end">
          ...
          <button
            ...
            className="bg-teal-600 hover:bg-teal-500 disabled:opacity-40 disabled:cursor-not-allowed text-white text-sm px-4 py-2.5 rounded-xl font-medium transition-colors shrink-0"
          >
            Send
          </button>
        </div>
